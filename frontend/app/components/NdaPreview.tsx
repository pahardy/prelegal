...
export default function NdaPreview({ data, onEdit }: Props) {
  ...
  const mndaFragment = mndaTermFragment(data);
      ...
      <div className="document-container max-w-3xl mx-auto bg-white shadow-lg rounded-xl p-10 font-serif text-gray-900">
              ...
              <tbody>
                {(
                  ...
                  <tr key={label}>
                    ...
                    <td className="py-3 px-4 border border-gray-300 text-center">{val1}</td>
                    <td className="py-3 px-4 border border-gray-300 text-center">{val2}</td>
                  </tr>
                ))}
              </tbody>
            </table>
        ...
        <section>
          ...
          <div className="space-y-4 text-sm leading-relaxed">
            <p>
              <span className="font-bold">1. Introduction.</span> This Mutual
              Non-Disclosure Agreement (which incorporates these Standard Terms and
              the Cover Page (defined below)) (&ldquo;<strong>MNDA</strong>&rdquo;)
              ...
              <Highlight>{data.purpose}</Highlight> which (1) the Disclosing Party
              ...
              this MNDA, the parties must complete and sign a cover page incorporating
              these Standard Terms (&ldquo;<strong>Cover Page</strong>&rdquo;). Each
            ...
            <p>
              ...
              the <Highlight>{data.purpose}</Highlight>; (b) not disclose Confidential
              Information to third parties without the Disclosing Party&apos;s prior
              ...
              <Highlight>{data.purpose}</Highlight>, provided these representatives
              are bound by confidentiality obligations no less protective of the
              Disclosing Party than the applicable terms in this MNDA and the
              Receiving Party remains responsible for their compliance with this MNDA;
              and (c) protect Confidential Information using at least the same
              protections the Receiving Party uses for its own similar information but
              no less than a reasonable standard of care.
            </p>

            <p>
              <span className="font-bold">3. Exceptions.</span> The Receiving
              Party&apos;s obligations in this MNDA do not apply to information that
              it can demonstrate: (a) is or becomes publicly available through no
              fault of the Receiving Party; (b) it rightfully knew or possessed prior
            ...
            <p>
              <span className="font-bold">4. Disclosures Required by Law.</span> The
              Receiving Party may disclose Confidential Information to the extent
              required by law, regulation or regulatory authority, subpoena or court
              ...
              and reasonably cooperates, at the Disclosing Party&apos;s expense, with
              the Disclosing Party&apos;s efforts to obtain confidential treatment for
              the Confidential Information.
            </p>

            <p>
              <span className="font-bold">5. Term and Termination.</span> This MNDA
              commences on <Highlight>{effectiveDateStr}</Highlight> and expires after{" "}
              <Highlight>{mndaFragment}</Highlight>. Either party may terminate this
              MNDA for any or no reason upon written notice to the other party. The
              Receiving Party&apos;s obligations relating to Confidential Information
              will survive for <Highlight>{confidentialityTerm}</Highlight>, despite
            ...
            <p>
              <span className="font-bold">7. Proprietary Rights.</span> The Disclosing
              Party retains all of its intellectual property and other rights in its
              Confidential Information and its disclosure to the Receiving Party grants
              no license under such rights.
            </p>

            <p>
              <span className="font-bold">8. Disclaimer.</span> ALL CONFIDENTIAL
              INFORMATION IS PROVIDED &ldquo;AS IS&rdquo;, WITH ALL FAULTS, AND
              WITHOUT WARRANTIES, INCLUDING THE IMPLIED WARRANTIES OF TITLE,
              MERCHANTABILITY AND FITNESS FOR A PARTICULAR PURPOSE.
            </p>

            <p>
              <span className="font-bold">9. Governing Law and Jurisdiction.</span>{" "}
              This MNDA and all matters relating hereto are governed by, and construed
              in accordance with, the laws of the State of{" "}
              <Highlight>{data.governingLaw}</Highlight>, without regard to the
              conflict of laws provisions of such{" "}
              <Highlight>{data.governingLaw}</Highlight>. Any legal suit, action, or
              proceeding relating to this MNDA must be instituted in the federal or
              state courts located in <Highlight>{data.jurisdiction}</Highlight>. Each
              party irrevocably submits to the exclusive jurisdiction of such{" "}
              <Highlight>{data.jurisdiction}</Highlight> in any such suit, action, or
              proceeding.
            </p>

            <p>
              <span className="font-bold">10. Equitable Relief.</span> A breach of
              this MNDA may cause irreparable harm for which monetary damages are an
              insufficient remedy. Upon a breach of this MNDA, the Disclosing Party
              is entitled to seek appropriate equitable relief, including an
              injunction, in addition to its other remedies.
            </p>

            <p>
              <span className="font-bold">11. General.</span> Neither party has an
              obligation under this MNDA to disclose Confidential Information to the
              other or proceed with any proposed transaction. Neither party may assign
              this MNDA without the prior written consent of the other party, except
              ...
              all its assets or voting securities. Any assignment in violation of this
              Section is null and void. This MNDA will bind and inure to the benefit
              of each party&apos;s permitted successors and assigns. Waivers must be
              signed by the waiving party&apos;s authorized representative and cannot
              be implied from conduct. If any provision of this MNDA is held
              unenforceable, it will be limited to the minimum extent necessary so the
              rest of this MNDA remains in effect. This MNDA (including the Cover
              Page) constitutes the entire agreement of the parties with respect to
              ...
              written or oral, regarding such subject matter. This MNDA may only be
              amended, modified, waived, or supplemented by an agreement in writing
              signed by both parties. Notices, requests and approvals under this MNDA
              must be sent in writing to the email or postal addresses on the Cover
              Page and are deemed delivered on receipt. This MNDA may be executed in
